...
AjaxSolr.BlogWidget = AjaxSolr.AbstractWidget.extend({
  start: 0,
  ...
  afterRequest: function () {
	...
	$(this.target).append('<div><p class="poweredBy">powered by <a class="bloglink" href="http://www.tor.com/" target="_blank"> tor.com</a></p></div></br>');
	first = false;
  },
  ...
  template: function (doc) {
	...
	//var output = '<div id="title_'+doc.id+'" class="doctitle"><h2>' + doc.title + '</h2>';
